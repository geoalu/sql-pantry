SELECT 
      ...
      PR.WORK_AREA_CODE,
      PR.WORK_PHONE_NUMBER,
      PR.WORK_EXTENSION_NUMBER,
      ad.address_line_1||ad.address_line_2||ad.address_line_3 ||' '||ad.city||' '||ad.region_cde ||' '||ad.country_cde||' '||ad.postal_code||' '||ad.zip_code  as Address,
      spa.intrid_sid, 
      spa.shape
