...
SELECT CAST( IP.INTRID_SID AS NUMBER) INTEREST_PARCEL_ID,
...
FROM WHSE_TANTALIS.TA_DISPOSITION_TRANSACTIONS DT 
  ...
  JOIN WHSE_TANTALIS.TA_INTEREST_PARCEL_SHAPES SPA
    ON SPA.INTRID_SID = IP.INTRID_SID

    WHERE (UNIT_NAME = 'LM - LAND MGMNT - LOWER MAINLAND SERVICE REGION' AND TT.STATUS_NME  = 'DISPOSITION IN GOOD STANDING' AND TYPE_NME = 'TRANSFER OF ADMINISTRATION/CONTROL')
    OR (UNIT_NAME = 'LM - LAND MGMNT - LOWER MAINLAND SERVICE REGION' AND TT.STATUS_NME = 'ACTIVE'  AND TYPE_NME = 'TRANSFER OF ADMINISTRATION/CONTROL')
    OR (UNIT_NAME = 'LM - LAND MGMNT - LOWER MAINLAND SERVICE REGION' AND TT.STATUS_NME = 'ACCEPTED' AND TYPE_NME = 'TRANSFER OF ADMINISTRATION/CONTROL')
